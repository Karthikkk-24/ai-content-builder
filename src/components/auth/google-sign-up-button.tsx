  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      const result = await signUp.sso({
        ...
        redirectCallbackUrl: `${clerkConfig.signUpUrl}/sso-callback`,
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Google sign-up failed. Enable Google in Clerk Dashboard → Social Connections."
      );
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-2">
      <Button
        ...
        disabled={!signUp || fetchStatus === "fetching" || loading}
      >
        {loading ? (
